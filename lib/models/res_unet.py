...
class UNet(nn.Module):
    def __init__(self, in_dim: int, out_dim: int, nG=64) -> None:
        ...
        from lib.models.modules.unet import (convBatch,
                                 residualConv,
                                 upSampleConv)
...
class UNet3D(nn.Module):
    def __init__(self, nin: int, nout: int, nG=64):
        ...
        from lib.models.modules.unet_3d import (convBatch,
                                    residualConv,
                                    upSampleConv)
...
class ResidualUNet(nn.Module):
    ...
    def __init__(self, in_dim: int, out_dim: int):
        ...
        from lib.models.modules.residualunet import (Conv_residual_conv,
                                         maxpool,
                                         conv_decod_block)
